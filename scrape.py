    ...
    for cat in section_cat:
        ...
        if tmp == 'for rent':
            for elem in cat.select('a'):
                categories_dict[elem.text + ' for rent'] = [elem['href'], 'for rent']
        elif tmp == 'for sale':
            for elem in cat.select('a'):
                categories_dict[elem.text + ' for sale'] = [elem['href'], 'for sale']
        elif tmp == 'new construction':
            for elem in cat.select('a'):
                categories_dict[elem.text + ' new construction'] = [elem['href'], 'new construction']
